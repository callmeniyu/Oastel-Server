...
class EmailService {
    ...
    async sendBookingConfirmation(booking) {
        try {
            ...
            console.log('SMTP Host:', email_config_1.emailConfig.smtp.host);
            console.log('SMTP Port:', email_config_1.emailConfig.smtp.port);
            console.log('SMTP Secure:', email_config_1.emailConfig.smtp.secure);
            console.log('SMTP User:', email_config_1.emailConfig.smtp.auth.user);
            console.log('SMTP Pass Length:', email_config_1.emailConfig.smtp.auth.pass ? email_config_1.emailConfig.smtp.auth.pass.length : 0);
            console.log('From Email:', email_config_1.emailConfig.from.email);
            // Test connection first
            await EmailService.transporter.verify();
            console.log('✅ SMTP connection verified successfully');
            const html = this.generateBookingConfirmationHTML(booking);
            const mailOptions = {
                from: `"${email_config_1.emailConfig.from.name}" <${email_config_1.emailConfig.from.email}>`,
     ...
     */
    async sendCartBookingConfirmation(cartData) {
        try {
            // Validate required environment variables
            if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
                console.error('❌ Missing required email environment variables:');
    ...
    generateBookingConfirmationHTML(booking) {
        ...
        const logoUrl = email_config_1.emailConfig.templates.logo;
        const bannerUrl = `${email_config_1.emailConfig.templates.website}/images/email-banner.jpg`;
        const baseUrl = email_config_1.emailConfig.templates.website;
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="email-text">Thank you for choosing ${email_config_1.emailConfig.from.name}! We're excited to confirm your booking for an amazing experience.</p>
            ...
            <!-- Footer -->
            <div class="footer">
                <p><strong>${email_config_1.emailConfig.from.name}</strong></p>
                <p>Your trusted travel partner</p>
                <div class="social-links">
                    <a href="mailto:${email_config_1.emailConfig.templates.supportEmail}">
                    ...
                    <a href="tel:${email_config_1.emailConfig.templates.supportPhone}">
                        <svg class="icon" style="width: 16px; height: 16px; margin-right: 4px;" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                        </svg>
                        Call
                    </a>
                    <a href="${email_config_1.emailConfig.templates.website}">
                        <svg class="icon" style="width: 16px; height: 16px; margin-right: 4px;" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p style="font-size: 12px; color: #bbb; margin-top: 20px; font-family: 'Poppins', sans-serif;">
                    ...
                    © ${new Date().getFullYear()} ${email_config_1.emailConfig.from.name}. All rights reserved.
                </p>
            </div>
        </div>
    </body>
     ...
     */
    generateCartBookingConfirmationHTML(cartData) {
        const formatDate = (dateString) => {
            try {
                if (!dateString)
                    return "Invalid Date";
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="email-text">Thank you for choosing ${email_config_1.emailConfig.from.name}! We're excited to confirm your ${totalBookings} booking${totalBookings > 1 ? 's' : ''} for amazing experiences.</p>
     ...
     */
    generateReviewRequestHTML(reviewData) {
        const formatDate = (dateString) => {
            try {
                if (!dateString)
                    return "Invalid Date";
    ...
    <body>
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="company-name">${email_config_1.emailConfig.from.name}</div>
            ...
            <div class="content">
                ...
                <div class="message">
                    Thank you for choosing ${email_config_1.emailConfig.from.name}. We look forward to serving you again soon! 
                    <br><br>
                    Warm regards,<br>
                    <strong>The ${email_config_1.emailConfig.from.name} Team</strong>
                </div>
            </div>
...
EmailService.transporter = nodemailer_1.default.createTransport(email_config_1.emailConfig.smtp);
